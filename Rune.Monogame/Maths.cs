...
namespace Rune.Monogame
{
    ...
    public static class Maths
    {
        ...
        public static Vector3 GetAabbFaceNormalRhs(Vector3 min, Vector3 max, Vector3 hitPosition)
        {
        ...
        public static void GetOrthogonalNormalsRhs(this Vector3 normal, out Vector3 horizontal, out Vector3 vertical)
        {
            normal.Normalize();

            Vector3 initial = Vector3.Up;
            if (initial.IsParallelTo(normal))
        ...
        public static Vector3 Floor(this Vector3 vector, float dimension)
        {
        ...
        public static Vector3 Round(this Vector3 vector, float dimension)
        {
        ...
        public static Vector3 Ceiling(this Vector3 vector, float dimension)
        {
        ...
        public static bool IsParallelTo(this Vector3 lhs, Vector3 rhs)
        {
            float dotProduct = Vector3.Dot(lhs, rhs);
            return 1 - Math.Abs(dotProduct) < EpsilonSmall;
        }
    }
}